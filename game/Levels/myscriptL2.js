var createScene = function (engine) {
    ...
    ground.material.diffuseTexture = new BABYLON.Texture("/recursos/gras.png", scene);
    ...
    wall1.material.diffuseTexture = new BABYLON.Texture("/recursos/park.png", scene);
    ...
    wall2.material.diffuseTexture = new BABYLON.Texture("/recursos/park.png", scene);
    ...
    wall3.material.diffuseTexture = new BABYLON.Texture("/recursos/park2.png", scene);

    var wall4 = ground.clone("wall1");
    wall4.position.x = -15;
    wall4.rotation.z = -90 * Math.PI / 180;
    wall4.material = ground.material.clone("lowerMat");
    wall4.material.diffuseTexture = new BABYLON.Texture("/recursos/park2.png", scene);
